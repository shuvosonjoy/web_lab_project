<?php
    ...
    $insert_query ="INSERT INTO `authentication`(`Username`, `Password`, `email`, `phone`) VALUES ( '$r_username','$r_pass',   '$r_email','$r_mobile')";
    

    $duplicate_email = mysqli_query($conn,"SELECT * FROM `web` WHERE email='$r_email'");
